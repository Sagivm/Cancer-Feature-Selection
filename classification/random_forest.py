...
def random_forest(X,y,k,activate_aug = False):
    """
    Activate random forest on X and y with preserving k features, activate aug if necessary
    :param X:
    :param y:
    :param k:
    :param activate_aug:
    ...
    for selection_func in [("com", selectfdr_fs)]:
        scores = list()
...
if __name__ == "__main__":
    ...
    random_forest(X, y, 5, activate_aug=True)
